...
module.exports = (db) => {
  ...
  router.get("/:id", (req, res) => {
    db.query(`SELECT * FROM goals where user_id = $1;`, [req.params.id])
      .then((data) => {
  ...
  router.post("/:id", upload.single("image"), (req, res) => {
    ...
    db.query(
      `INSERT INTO goals (user_id, title, description, image, start_date, end_date)
  ...
  router.put("/edit/:id", upload.single("image"), (req, res) => {
    db.query(
      `UPDATE goals SET title = $1, description = $2, image=$3, start_date=$4, end_date=$5
     WHERE id = $6;`,
      [
        req.body.title,
        req.body.description,
